...
function p(
  ...
  return { id, name, bg, text, muted, accent, onAccent, dark };
}
...
export const EASY_PALETTES: readonly EasyPalette[] = [
  ...
  p("cream-brown", "Cream & brown", "#f6efe3", "#3a2b1c", "#7a6a56", "#8a5a2b", "#ffffff"),
  ...
  p("white-silver", "White & silver", "#fbfbfc", "#26262c", "#71717c", "#8b8f98", "#ffffff"),
  p("deep-red-black", "Deep red & black", "#1c0f12", "#f6e7e9", "#c2a3a8", "#e11d48", "#ffffff", true),
  p("navy-white", "Navy & white", "#12233f", "#f4f7fb", "#9fb0c8", "#f4f7fb", "#12233f", true),
  ...
  p("holo-white", "White & holographic", "#ffffff", "#232330", "#6a6a78", "#7c6bd9", "#ffffff"),
  ...
  p("blue-prism", "Blue prism", "#12224a", "#eaf1ff", "#9cb1de", "#60a5fa", "#0f1c3d", true),
  p("pastel-iris", "Pastel iridescent", "#f7f4fb", "#3d3654", "#7d7495", "#8b7ad9", "#ffffff"),
  // --- Neon ------------------------------------------------------------------
  p("neon-cyan-magenta", "Black, cyan & magenta", "#0b0b10", "#eefcff", "#8fd6e0", "#e11ec9", "#ffffff", true),
  ...
  p("neon-pink-orange", "Pink & orange", "#1c0d14", "#fff0f4", "#d8a4b4", "#f43f5e", "#ffffff", true),
  ...
  // --- Botanical / kraft -----------------------------------------------------
  p("kraft-ink", "Kraft & ink", null, "#2c2014", "#5f4c36", "#2c2014", "#f4e8d6"),
  ...
  p("clear-white", "Clear with white print", null, "#ffffff", "#d8d8de", "#ffffff", "#17171c", true),
] as const;
